...
import 'package:a/components/image.dart';
...
class _CalculatriceState extends State<Calculatrice> {
 String _number = "0";
  ...
  Widget build(BuildContext context) {
    ...
    title: const Text("Ma Calculatrice", style: TextStyle(color: Colors.white)),
  ),
            ...
            Row(
             ...
             Container(
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => image()));
              },
